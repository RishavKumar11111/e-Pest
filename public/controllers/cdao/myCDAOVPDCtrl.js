app.controller('myCDAOVPDCtrl', function($scope, $http, $filter) {
    ...
    $scope.pestDetails = [];
    $scope.ete = false;
    $scope.getCDAOPestDetails = function() {
        if ($scope.ddlUT != null && $scope.ddlUT != undefined && $scope.dateOfPDE != null && $scope.dateOfPDE != undefined && $scope.rbs != null && $scope.rbs != undefined && $scope.ddlFY != null && $scope.ddlFY != undefined && $scope.ddlCC != null && $scope.ddlCC != undefined && $scope.ddlC != null && $scope.ddlC != undefined) {
            ...
            $http.get('http://localhost:3000/cdao/getCDAOPestDetails?dateOfEntry=' + document.getElementById('pdeDate').value + '&season=' + $scope.rbs + '&financialYear=' + $scope.ddlFY + '&blockCode=' + blkcd + '&cropCategoryCode=' + $scope.ddlCC + '&cropCode=' + $scope.ddlC + '&pestDiseaseCode=' + pdcd + '&userType=' + $scope.ddlUT).then(function success(response) {
