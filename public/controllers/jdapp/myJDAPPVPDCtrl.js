app.controller('myJDAPPVPDCtrl', function($scope, $http, $filter) {
    ...
    $scope.getCropsByCategory = function () {
        if ($scope.ddlCC != undefined) {
            $http.get('http://localhost:3000/jdapp/getCropsByCategory?cropCategoryCode=' + $scope.ddlCC).then(function success(response) {
    ...
    $scope.getAllPestDiseases = function () {
        if ($scope.ddlC != undefined) {
            $http.get('http://localhost:3000/jdapp/getPestDiseases?cropCode=' + $scope.ddlC).then(function success(response) {
    ...
    $scope.getPestDetails = function() {
        if ($scope.ddlUT != null && $scope.ddlUT != undefined && $scope.dateOfPDE != null && $scope.dateOfPDE != undefined && $scope.rbs != null && $scope.rbs != undefined && $scope.ddlFY != null && $scope.ddlFY != undefined && $scope.ddlCC != null && $scope.ddlCC != undefined && $scope.ddlC != null && $scope.ddlC != undefined) {
            ...
            $http.get('http://localhost:3000/jdapp/getPestDetails?dateOfEntry=' + document.getElementById('pdeDate').value + '&season=' + $scope.rbs + '&financialYear=' + $scope.ddlFY + '&districtCode=' + distcd + '&blockCode=' + blkcd + '&cropCategoryCode=' + $scope.ddlCC + '&cropCode=' + $scope.ddlC + '&pestDiseaseCode=' + pdcd + '&userType=' + $scope.ddlUT).then(function success(response) {
