app.controller('myJDAPPLTCRCtrl', function ($scope, $http, $filter) {
    ...
    $scope.getLTCCrops = function () {
        $http.get('http://localhost:3000/jdapp/getLTCCrops').then(function success(response) {
    ...
    $scope.getLTCPestDiseases = function () {
        if ($scope.ddlC != undefined) {
            $http.get('http://localhost:3000/jdapp/getLTCPestDiseases?cropCode=' + $scope.ddlC).then(function success(response) {
    ...
    $scope.getLTCDetails = function () {
        if ($scope.dateOfPDE != null && $scope.dateOfPDE != undefined && $scope.rbs != null && $scope.rbs != undefined && $scope.ddlFY != null && $scope.ddlFY != undefined && $scope.ddlC != null && $scope.ddlC != undefined) {
            ...
            $http.get('http://localhost:3000/jdapp/getLTCDetails?dateOfEntry=' + document.getElementById('pdeDate').value + '&season=' + $scope.rbs + '&financialYear=' + $scope.ddlFY + '&districtCode=' + distcd + '&blockCode=' + blkcd + '&cropCode=' + $scope.ddlC + '&pestDiseaseCode=' + pdcd).then(function success(response) {
