app.controller('myOUATEMRCRCtrl', function ($scope, $http, $filter, $timeout) {
    ...
    $scope.getEMRNos = function () {
        if ($scope.dateOfPDE != null && $scope.dateOfPDE != undefined && $scope.ddlFY != null && $scope.ddlFY != undefined && $scope.ddlCrop != null && $scope.ddlCrop != undefined && $scope.ddlCropCategory != null && $scope.ddlCropCategory != undefined) {
            ...
            $http.get('http://localhost:3000/ouat/getEMRNos?dateOfEntry=' + document.getElementById('pdeDate').value + '&cropCategory=' + $scope.ddlCropCategory + '&crop=' + $scope.ddlCrop + '&financialYear=' + $scope.ddlFY + '&districtCode=' + distcd + '&blockCode=' + blkcd).then(function success(response) {
    ...
    $scope.getEMRReferenceNoDetails = function (emrRefNo) {
        $http.get('http://localhost:3000/ouat/getEMRReferenceNoDetails?emrRefNo=' + emrRefNo).then(function success(response) {
