app.controller('myADOEMRCRCtrl', function($scope, $http, $filter, $timeout) {
    ...
    $scope.getEMRReferenceNoDetailsADO = function (emrRefNo) {
        $http.get('http://localhost:3000/ado/getEMRReferenceNoDetailsADO?emrRefNo=' + emrRefNo).then(function success(response) {
